...
class crudEditTest extends base
{
    ...
    public function testCrudEditForm(): void
    {
        ...
        // obsolete?
        static::assertEquals('example', app::getResponse()->getData('editActions'));
    }
    ...
    public function testCrudEditFormSendSuccess(): void
    {
        ...
        static::assertEquals('XYZ', $form->getField('testmodel_text')->getProperty('field_value'));
        ...
        app::getRequest()->setData('testmodel_text', 'changed');
        ...
        static::assertEquals('changed', $res[0]['testmodel_text']);
    }
