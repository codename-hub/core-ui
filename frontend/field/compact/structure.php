...
$response->requireResource('js', '/assets/plugins/jsoneditor/jsoneditor.min.js');
$response->requireResource('css', '/assets/plugins/jsoneditor/jsoneditor.min.css');
$response->requireResource('js', '/assets/plugins/jsoneditor/jsoneditor.min.js');
?>
...
<script>
  // create the editor
  let container = document.getElementById("<?=$data['field_id']?>");
  ...
  // set json
  let json = JSON.parse(document.getElementById("<?=$data['field_id']?>-value").value);
